...
//Gere um MockClient usando o pacote Mockito.
// Cria novas instâncias desta classe em cada teste.
...
void main() {
  group('fetch todos', () {
    test('returns a list of todo items if call is successful', () async {
      ...
      // Use o Mockito para retornar uma resposta bem-sucedida quando ele chamar o
      // forneceu http.Cliente.
    ...
    test('throws an exception if the http call completes with an error', () {
      ...
      // Use o Mockito para retornar uma resposta malsucedida quando ele chamar o
      // forneceu http.Cliente.
